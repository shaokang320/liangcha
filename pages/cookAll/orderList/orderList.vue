				...
				<view class="c660">
					<view class="title">
						<view class="t-l">
							...
							<text class="text">广州白云店</text>
						</view>
						<view class="t-r">
							<text>2019-08-08 15:04</text>
					...
					<view class="ul">
						<view class="li">
							<view class="pic">
								<image :src="staticURL + 'test/index02.png'"></image>
							</view>
							<view class="detail">
								<view class="name text1">
									<text>精品12人套餐</text>
								</view>

								<view class="desc">
									预约时间：2019-08-08 08:30
								</view>
							</view>
