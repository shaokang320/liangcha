...
var mutations = {
  ...
  // 店铺信息
  SET_STOREINFO: function SET_STOREINFO(state, storeInfo) {
    state.storeInfo = Object.assign({}, state.storeInfo, storeInfo);
  },
  // 店铺id
  SET_STOREID: function SET_STOREID(state, storeId) {
    state.storeId = storeId;
  },
  // 桌号id和桌号name
  SET_TABLE: function SET_TABLE(state, data) {
    state.tableId = data.id;
    state.tableName = data.name;
  },
  // 桌号点餐人数
  SET_TABLENUM: function SET_TABLENUM(state, num) {
    state.tableNum = num;
  },
  // 设置TOKEN
  ...
  // 授权状态
  SET_AUTHORIZE: function SET_AUTHORIZE(state, anthor) {
...
var actions = {
  ...
  // },
  changeCart: function changeCart(_ref,

  cart) {var commit = _ref.commit,state = _ref.state;
    console.log(cart);
    var data = {
      count: 0,
      totalPrice: 0,
      list: state.scanAll.cart.push(cart) };var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {

      for (var _iterator = data.list[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var item = _step.value;
        data.count += item.num;
        data.totalPrice += parseFloat(item.num * item.price);
      }} catch (err) {_didIteratorError = true;_iteratorError = err;} finally {try {if (!_iteratorNormalCompletion && _iterator.return != null) {_iterator.return();}} finally {if (_didIteratorError) {throw _iteratorError;}}}
    commit('SET_CART', data);
  } };

var getters = {
  changeCount: function changeCount(state) {var count = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _config = __webpack_require__(/*! ./config */ 18);
var utils = {
  show: function show() {var mask = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;var title = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '加载中···';
    uni.showLoading({
      title: title,
      mask: mask });
  ...
  toast: function toast() {var title = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '请稍后···';var icon = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'none';var mask = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;var time = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1000;
    uni.showToast({
      title: title,
      icon: icon,
      mask: mask,
  ...
  // 传数组or对象
  goPageJson: function goPageJson(url, params) {
    var path = '';
    if (params) {
      var par = JSON.stringify(params);
      path = "".concat(url, "?params=").concat(par);
    } else {
      path = url;
    }
    uni.navigateTo({
  ...
  uploadingImg: function uploadingImg(imgUrls) {
    //启动上传等待中...  
    uni.showLoading({ title: '上传中' });
    var i = 0;
    var returnImgUrls = []; //返回的所有图片链接
    uploadImg(imgUrls[i]);
    function uploadImg(path) {
      wx.uploadFile({
        url: _config.uploadURL + '/image_upload',
        filePath: path,
        header: {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.requestURL = exports.uploadURL = exports.staticURL = void 0;var staticURL = '../../../static/'; //本地静态图片地址
exports.staticURL = staticURL;var uploadURL = '上传图片地址'; //上传图片地址 
exports.uploadURL = uploadURL;var requestURL = 'https://dos.newheightchina.com/api/weixin/'; //ajax请求地址
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.foodClass = foodClass;exports.foodList = foodList;
var _request = _interopRequireDefault(__webpack_require__(/*! ../utils/request.js */ 26));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /* 扫码点餐 */
function foodClass(data) {//菜品分类
  return (0, _request.default)(data, "foodClass");
}
function foodList(data) {//菜品列表
  return (0, _request.default)(data, "foodList");
}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.index = index;exports.video = video;exports.my = my;var _request = _interopRequireDefault(__webpack_require__(/*! ../utils/request.js */ 26));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}


/* 首页 */
function index(data) {//提交用户信息
  return (0, _request.default)(data, "index");
}
/* 美厨 */
function video(data) {
  return (0, _request.default)(data, '/video/video').then(function (res) {return res;});
}
/* 我的 */
function my(data) {
  return (0, _request.default)(data, '/my/my').then(function (res) {return res;});
}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var mock = { //座位
  da: {
    money: 50,
    seatList: [{
      num: 2,
      name: '2人/桌',
      disabled: true, //是否已被禁用
      list: [
      {
        name: 1,
        status: false, //是否已被预约
...
var Request = function Request(data, url) {
  var coreParams = {};
  if (_store.default.state.access_token) {coreParams.access_token = _store.default.state.access_token;};
  if (_store.default.state.storeID) {coreParams.storeId = _store.default.state.storeID;};
...
module.exports = __webpack_require__(/*! regenerator-runtime */ 428);
...
module.exports = __webpack_require__(/*! ./runtime */ 429);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.apiWeiXinLogin = apiWeiXinLogin;var _request = _interopRequireDefault(__webpack_require__(/*! ../utils/request.js */ 26));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

function apiWeiXinLogin(data) {//用户登录
  return (0, _request.default)(data, "login");
}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__98D49B5" };exports.default = _default;
